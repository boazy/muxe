...
complete -c muxe -n "__fish_muxe_using_subcommand menu; and not __fish_seen_subcommand_from open help" -s h -l help -d 'Print help'
complete -c muxe -n "__fish_muxe_using_subcommand menu; and not __fish_seen_subcommand_from open help" -s V -l version -d 'Print version'
complete -c muxe -n "__fish_muxe_using_subcommand menu; and not __fish_seen_subcommand_from open help" -f -a "open" -d 'Open a root menu as a focused modal UI'
complete -c muxe -n "__fish_muxe_using_subcommand menu; and not __fish_seen_subcommand_from open help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c muxe -n "__fish_muxe_using_subcommand help; and not __fish_seen_subcommand_from init menu pane integration activate broker compatibility purge ui help" -f -a "init" -d 'Create the starter configuration without installing host integration'
complete -c muxe -n "__fish_muxe_using_subcommand help; and not __fish_seen_subcommand_from init menu pane integration activate broker compatibility purge ui help" -f -a "menu" -d 'Open a configured root menu through a host launcher'
complete -c muxe -n "__fish_muxe_using_subcommand help; and not __fish_seen_subcommand_from init menu pane integration activate broker compatibility purge ui help" -f -a "pane" -d 'Open a generic command pane'
complete -c muxe -n "__fish_muxe_using_subcommand help; and not __fish_seen_subcommand_from init menu pane integration activate broker compatibility purge ui help" -f -a "integration" -d 'Install or remove managed host integration'
complete -c muxe -n "__fish_muxe_using_subcommand help; and not __fish_seen_subcommand_from init menu pane integration activate broker compatibility purge ui help" -f -a "activate" -d 'Activate this version for selected live hosts'
complete -c muxe -n "__fish_muxe_using_subcommand help; and not __fish_seen_subcommand_from init menu pane integration activate broker compatibility purge ui help" -f -a "broker" -d 'Manage broker lifecycle'
complete -c muxe -n "__fish_muxe_using_subcommand help; and not __fish_seen_subcommand_from init menu pane integration activate broker compatibility purge ui help" -f -a "compatibility" -d 'Print the embedded compatibility record'
complete -c muxe -n "__fish_muxe_using_subcommand help; and not __fish_seen_subcommand_from init menu pane integration activate broker compatibility purge ui help" -f -a "purge" -d 'Remove explicitly selected retained Muxe data'
complete -c muxe -n "__fish_muxe_using_subcommand help; and not __fish_seen_subcommand_from init menu pane integration activate broker compatibility purge ui help" -f -a "ui" -d 'Run the native terminal UI'
complete -c muxe -n "__fish_muxe_using_subcommand help; and not __fish_seen_subcommand_from init menu pane integration activate broker compatibility purge ui help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
